...
datagroup: raj_look_default_datagroup {
   sql_trigger: SELECT MAX(id) FROM etl_log;;
  max_cache_age: "1 hour"
}
persist_with: raj_look_default_datagroup
...
sql_always_where: {% if order_items.yes_no._parameter_value == 'Yes' %}
                  ${orders.created_year} = 2016
                  {% else %}
${orders.created_year} = 2017
{% endif %};;
